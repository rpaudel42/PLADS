...
typedef struct 
{
   ...
   BOOLEAN optimize;     // user option to skip certain processing and assume 
                         // solution is near
/////////////////////////////////////////////////////// WFE - PLADS
   ULONG partitionNum;   // partition number, used for unique naming of file
   char graphInputFile[FILE_NAME_LEN];   // just the name of graph input file,
                                         // no directory
   BOOLEAN plads;        // is GBAD being run inside of PLADS?
   char bestSubFile[FILE_NAME_LEN];   // name and path of best sub file
   BOOLEAN bestSub;      // is a "best sub" file requested to be used?
   char *executablePath; // path to gbad executable
/////////////////////////////////////////////////////// WFE - PLADS
} Parameters;
...
/////////////////////////////////////////////////////// WFE - PLADS
void WriteNormGraphToFile(ULONG , Graph *, LabelList *, ULONG, ULONG, ULONG, 
                          ULONG, ULONG, ULONG, char *);
void WriteAnomGraphToFile(Graph *, LabelList *, ULONG, ULONG, ULONG, ULONG, 
                          ULONG, double);
void WriteAnomInstanceToFile(Instance *, Graph *, Parameters *, ULONG);
Graph *ReadGraph(char *, LabelList *, BOOLEAN);
void ReadVertex(Graph *, FILE *, LabelList *, ULONG *, ULONG *, ULONG);
void ReadEdge(Graph *, FILE *, LabelList *, ULONG *, ULONG *, BOOLEAN, ULONG);
...
/////////////////////////////////////////////////////// WFE - PLADS
void PrintLabelToFile(FILE *, ULONG, LabelList *);
/////////////////////////////////////////////////////// WFE - PLADS
