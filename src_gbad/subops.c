...
/////////////////////////////////////////// WFE - PLADS ///////////////////////
// 02/27/14  Eberle     Modified PrintSubList to also call WriteNormGraphToFile
//                      to be used by PLADS.
/////////////////////////////////////////// WFE - PLADS ///////////////////////
//
//******************************************************************************
...
void PrintSubList(SubList *subList, Parameters *parameters)
{
   ...
   if (subList != NULL) 
   {
      ...
      while (subListNode != NULL) 
      {
         printf("(%lu) ", counter);
/////////////////////////////////////////// WFE - PLADS ///////////////////////
         if (parameters->partitionNum > 0 && !parameters->plads)
            WriteNormGraphToFile(counter, subListNode->sub->definition,
                                 parameters->labelList, 0, 0,
                                 subListNode->sub->definition->numVertices,
                                 subListNode->sub->numInstances,
                                 parameters->partitionNum, counter,
                                 parameters->graphInputFile);
/////////////////////////////////////////// WFE - PLADS ///////////////////////
         counter++;
