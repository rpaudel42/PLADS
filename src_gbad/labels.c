...
///////////////////////////////////// WFE - PLADS ////////////////////////////////////////
//******************************************************************************
// NAME:    PrintLabelToFile
//
// INPUTS:  (FILE *outFile) - file to write label to
//          (ULONG index) - index into label list
//          (LabelList *labelList) - list of labels
//
// RETURN:  void
//
// PURPOSE: Print label of given index to specified output file.
//******************************************************************************

void PrintLabelToFile(FILE *outFile, ULONG index, LabelList *labelList)
{
   UCHAR labelType;
